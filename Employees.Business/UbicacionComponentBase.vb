...
Public Partial Class UbicacionComponentBase
	...
	Public Overridable Function Validate(Byref entity as Ubicacion) As Boolean
      ...
      Catch ex As Exception
            ...
            MyBase.Error = "No se pudo validar la Ubicacion"
	...
	Public Overridable Function ValidateNew(Byref entity as Ubicacion) As Boolean
		Dim bOk As Boolean = True
        Try
	...
	Public Overridable Function ValidateDelete(Byref entity as Ubicacion) As Boolean
		Return False
	End Function


	Public Function Save(Byref col As List (of Ubicacion), Optional ByVal sp as Boolean = true, Optional byref QInsert As Integer = 0, Optional ByRef QUpdate As Integer = 0, Optional ByVal ThrowErr As Boolean = False) As Boolean
		Dim UbicacionDal as New UbicacionData
		Dim bResul As Boolean = True
		Dim strError As String = String.Empty
		Dim flgHuboCambios As Boolean = False
		Try
			UbicacionDal.BeginTransaction()
			For Each entity As Ubicacion In col
        	...
        	Catch ex As Exception
				...
				strLog &= "Error Ubicacion.Save (" & TimeOfDay.ToString("HH:mm:ss tt") & ")" & vbCrLf
        	...
        	Finally
				UbicacionDal.Desconectar()
        	End Try
        	Return bResul
	End Function


	Public Function Save(Byref entity As Ubicacion, Optional ByVal sp as Boolean = true, Optional ByVal ThrowErr As Boolean = False) As Boolean
	...
	Private Function Insert(Byref entity as Ubicacion, Optional ByVal sp as Boolean = true, Optional ByVal ThrowErr As Boolean = False) As Boolean
		Dim oDal As New UbicacionData
		Dim bOk As Boolean = false
		Try
	...
	Private Function Update(Byref entity as Ubicacion, Optional ByVal sp as Boolean = true, Optional ByVal ThrowErr As Boolean = False) As Boolean
		Dim oDal As New UbicacionData
		Dim bOk As Boolean = false
		Try
	...
	Public Function GetEntById(Byval ID as Long , Optional ByVal ThrowErr As Boolean = False) As Ubicacion
		Dim oDal As New UbicacionData
	...
	Public Function GetListByEnt(ByVal entity As Ubicacion, Optional ByVal ThrowErr As Boolean = False) As List(Of Ubicacion)
        Dim oDal As New UbicacionData
        Dim listentity As New List(Of Ubicacion)
        Try
