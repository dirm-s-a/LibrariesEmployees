...
<Serializable()> Public Partial Class HorarioEmpleado
	Inherits BaseEntity
...
#Region "Table Fields"
	...
	Private mDIASEMANAENTRADA as Integer
			
	Private mDIASEMANASALIDA as Integer
	...
	Private mINCLUYEFERIADOS as Boolean
...
'	Default Constructor
	...
	Public Sub New()
		...
		mDIASEMANAENTRADA = F_Set_NullValue(mDIASEMANAENTRADA)
		mDIASEMANASALIDA = F_Set_NullValue(mDIASEMANASALIDA)
		...
		mINCLUYEFERIADOS = F_Set_NullValue(mINCLUYEFERIADOS)
	...
	Public Sub New(
			...
			Byval DIASEMANAENTRADA as Integer,
			Byval DIASEMANASALIDA as Integer,
		...
		Me.DIASEMANAENTRADA = DIASEMANAENTRADA
		Me.DIASEMANASALIDA = DIASEMANASALIDA
...
#Region	"Public Properties"
	...
	Public Property DIASEMANAENTRADA() as Integer
        Get
            Return mDIASEMANAENTRADA
        End Get
        Set(ByVal Value As Integer)
			MyBase.ChangeProperty("DIASEMANAENTRADA", Value)
            mDIASEMANAENTRADA = Value
        End Set
	End Property
	
	Public Property DIASEMANASALIDA() as Integer
        Get
            Return mDIASEMANASALIDA
        End Get
        Set(ByVal Value As Integer)
			MyBase.ChangeProperty("DIASEMANASALIDA", Value)
            mDIASEMANASALIDA = Value
        End Set
	End Property
	...
	Public Property INCLUYEFERIADOS() as Boolean
        Get
            Return mINCLUYEFERIADOS
        End Get
        Set(ByVal Value As Boolean)
			MyBase.ChangeProperty("INCLUYEFERIADOS", Value)
            mINCLUYEFERIADOS = Value
        End Set
	End Property
